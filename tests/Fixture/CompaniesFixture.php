...
class CompaniesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'kname' => ['type' => 'string', 'length' => 12, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '企業名(表示名)', 'precision' => null, 'fixed' => null],
        'name' => ['type' => 'string', 'length' => 80, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '企業名(正式)', 'precision' => null, 'fixed' => null],
        'company_kbn' => ['type' => 'string', 'length' => 9, 'null' => false, 'default' => '0', 'collate' => 'utf8_general_ci', 'comment' => '企業区分(0:すべて/1:製造元/2:仕入先/3:販売元/4:配送業者)', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'dsts' => 1,
            'created_at' => '2017-12-15 18:51:42',
            'created_user' => 1,
            'modified_at' => '2017-12-15 18:51:42',
            'modified_user' => 1
        ],
    ];
}
