...
class CustomersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'kname' => ['type' => 'string', 'length' => 14, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '取引先名(キー)', 'precision' => null, 'fixed' => null],
        'name' => ['type' => 'string', 'length' => 40, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '取引先名', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'customers_udx' => ['type' => 'unique', 'columns' => ['domain_id', 'kname'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'dsts' => 1,
            'created_at' => '2017-11-14 15:21:23',
            'created_user' => 1,
            'modified_at' => '2017-11-14 15:21:23',
            'modified_user' => 1
        ],
    ];
}
