 ...
 *
 */
class InstockPlansFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'plan_date' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '入庫予定日', 'precision' => null],
        'name' => ['type' => 'string', 'length' => 60, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '入庫件名', 'precision' => null, 'fixed' => null],
        'plan_sts' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '入庫状況 - snames[INSTOCK_STS]', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'instock_plans_idx01' => ['type' => 'index', 'columns' => ['domain_id', 'plan_date'], 'length' => []],
            'instock_plans_idx02' => ['type' => 'index', 'columns' => ['plan_sts'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            'id' => 1,
            'domain_id' => 1,
            'plan_date' => '2017-12-21',
            'name' => 'Lorem ipsum dolor sit amet',
            'plan_sts' => 'Lorem ipsum dolor sit amet',
            'remarks' => 'Lorem ipsum dolor sit amet',
            'dsts' => 1,
            'created_at' => '2017-12-21 14:03:18',
            'created_user' => 1,
            'modified_at' => '2017-12-21 14:03:18',
            'modified_user' => 1
        ],
    ];
}
