...
class DomainsFixture extends TestFixture
{
    ...
    public $fields = [
        'id' => ['type' => 'smallinteger', 'length' => 5, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => 'ID - 値:0は共通ドメインとして使用', 'precision' => null],
        'kname' => ['type' => 'string', 'length' => 6, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'ドメイン名(キー)', 'precision' => null, 'fixed' => null],
        'name' => ['type' => 'string', 'length' => 40, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'ドメイン名', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'domains_udx' => ['type' => 'unique', 'columns' => ['kname'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'dsts' => 1,
            'created_at' => '2017-11-07 10:06:39',
            'created_user' => 1,
            'modified_at' => '2017-11-07 10:06:39',
            'modified_user' => 1
        ],
    ];
}
