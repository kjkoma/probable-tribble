...
class OrganizationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'kname' => ['type' => 'string', 'length' => 14, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '組織名(キー)', 'precision' => null, 'fixed' => null],
        'name' => ['type' => 'string', 'length' => 40, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '組織名', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'organizations_udx' => ['type' => 'unique', 'columns' => ['domain_id', 'customer_id', 'kname'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'dsts' => 1,
            'created_at' => '2017-11-28 16:29:32',
            'created_user' => 1,
            'modified_at' => '2017-11-28 16:29:32',
            'modified_user' => 1
        ],
    ];
}
