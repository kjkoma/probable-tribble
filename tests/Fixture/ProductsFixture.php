...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'classification_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '製品分類 - classifications.id', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'dsts' => 1,
            'created_at' => '2017-12-18 09:50:42',
            'created_user' => 1,
            'modified_at' => '2017-12-18 09:50:42',
            'modified_user' => 1
        ],
    ];
}
