 ...
 *
 */
class SrolesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'kname' => ['type' => 'string', 'length' => 12, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'ロール名(識別)', 'precision' => null, 'fixed' => null],
        'name' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'ロール名', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'sroles_udx' => ['type' => 'unique', 'columns' => ['kname'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'dsts' => 1,
            'created_at' => '2017-11-07 10:01:19',
            'created_user' => 1,
            'modified_at' => '2017-11-07 10:01:19',
            'modified_user' => 1
        ],
    ];
}
