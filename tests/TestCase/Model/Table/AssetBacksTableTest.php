...
use App\Model\Table\AssetBacksTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\AssetBacksTable Test Case
 */
class AssetBacksTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\AssetBacksTable
     */
    public $AssetBacks;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('AssetBacks') ? [] : ['className' => AssetBacksTable::class];
        $this->AssetBacks = TableRegistry::get('AssetBacks', $config);
    }
