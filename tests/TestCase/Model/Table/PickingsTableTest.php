...
use App\Model\Table\PickingsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PickingsTable Test Case
 */
class PickingsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PickingsTable
     */
    public $Pickings;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Pickings') ? [] : ['className' => PickingsTable::class];
        $this->Pickings = TableRegistry::get('Pickings', $config);
    }
