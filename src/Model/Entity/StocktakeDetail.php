 ...
 * @property \Cake\I18n\FrozenDate $read_date
 * @property int $read_suser_id
 * @property int $dsts
 ...
 * @property \App\Model\Entity\ReadSuser $read_suser
 */
class StocktakeDetail extends AppEntity
{
